...
PERSONALID_CREDENTIALS_CLIENT_ID = env("PERSONALID_CREDENTIALS_CLIENT_ID", default="")
PERSONALID_CREDENTIALS_CLIENT_SECRET = env("PERSONALID_CREDENTIALS_CLIENT_SECRET", default="")
