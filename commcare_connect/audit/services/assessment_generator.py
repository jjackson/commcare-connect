...
Generates assessments for audit sessions based on available data.
...
def generate_assessments_for_session(session: AuditSession) -> dict:
    """
    Generate assessments for all visits in an audit session.

    Currently generates image assessments. Future: flags, form data elements.

    Args:
        session: AuditSession to generate assessments for
    ...
    # Get all visits in this session
