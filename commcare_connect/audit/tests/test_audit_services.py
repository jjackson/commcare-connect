...
class AuditCreationServiceTest(TestCase):
    ...
    def test_create_audit_sessions_combined_granularity(self):
        ...
        # Verify success and one session created
        assert result.success is True
        assert result.sessions_created == 1
        assert result.first_session.status == AuditSession.Status.IN_PROGRESS
    ...
    def test_create_audit_sessions_per_flw_granularity(self):
        ...
        # Verify success and two sessions created (one per FLW)
        assert result.success is True
    ...
    def test_create_audit_sessions_with_flw_limit(self):
        ...
        # Verify only 3 sessions created (limited)
        assert result.success is True
