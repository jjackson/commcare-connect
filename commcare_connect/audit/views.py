...
# Old views removed - see experiment_views.py for new implementation
# These views have been replaced with experiment-based implementations:
# - AuditCreationWizardView -> ExperimentAuditCreateView
# - ProgramSearchAPIView -> ExperimentOpportunitySearchAPIView
# - ProgramOpportunitiesAPIView -> (deprecated)
# - AuditPreviewAPIView -> ExperimentAuditPreviewAPIView
# - AuditCreateAPIView -> ExperimentAuditCreateAPIView
# - AuditProgressAPIView -> ExperimentAuditProgressAPIView


# [REMOVED] Old audit creation views - replaced by experiment-based views
