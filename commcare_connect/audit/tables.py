...
class AuditSessionTable(tables.Table):
    """Table for displaying audit sessions"""
    ...
    class Meta:
        ...
        empty_text = _("No audit sessions yet. Create your first audit session to get started.")
    ...
    def render_status(self, value, record):
        ...
        if value == AuditSession.Status.COMPLETED:
            badge_class = "badge badge-sm bg-green-50 text-green-700"
            text = _("Completed")
        elif value == AuditSession.Status.IN_PROGRESS:
