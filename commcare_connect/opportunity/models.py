...
class OpportunityAccess(models.Model):
    opportunity_access_id = models.UUIDField(editable=False, null=False, default=uuid4)
...
class PaymentUnit(models.Model):
    payment_unit_id = models.UUIDField(editable=False, null=False, default=uuid4)
    opportunity = models.ForeignKey(Opportunity, on_delete=models.PROTECT)
...
class Payment(models.Model):
    payment_id = models.UUIDField(editable=False, null=False, default=uuid4)
...
class FormJsonValidationRules(models.Model):
    form_json_validation_rules_id = models.UUIDField(editable=False, null=False, default=uuid4)
    slug = models.SlugField()
