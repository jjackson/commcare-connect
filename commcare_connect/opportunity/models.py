...
class Opportunity(BaseModel):
    opportunity_id = models.UUIDField(editable=False, null=False, default=uuid4, unique=True)
    organization = models.ForeignKey(
        Organization,
        on_delete=models.CASCADE,
...
class OpportunityAccess(models.Model):
    opportunity_access_id = models.UUIDField(editable=False, null=False, default=uuid4, unique=True)
...
class PaymentUnit(models.Model):
    payment_unit_id = models.UUIDField(editable=False, null=False, default=uuid4, unique=True)
    opportunity = models.ForeignKey(Opportunity, on_delete=models.PROTECT)
...
class Payment(models.Model):
    payment_id = models.UUIDField(editable=False, null=False, default=uuid4, unique=True)
...
class FormJsonValidationRules(models.Model):
    form_json_validation_rules_id = models.UUIDField(editable=False, null=False, default=uuid4, unique=True)
    slug = models.SlugField()
