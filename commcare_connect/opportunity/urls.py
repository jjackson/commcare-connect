...
urlpatterns = [
    ...
    path("<int:opp_id>/add_budget_existing_users", view=add_budget_existing_users, name="add_budget_existing_users"),
    path("<int:opp_id>/add_budget_new_users", view=add_budget_new_users, name="add_budget_new_users"),
    ...
    path("<int:opp_id>/invoice/submit/", views.submit_invoice, name="submit_invoice"),
    ...
    # Worker List
    path("<int:opp_id>/workers/", WorkerView.as_view(), name="worker_list"),
    path("<int:opp_id>/workers/learn/", WorkerLearnView.as_view(), name="worker_learn"),
    path("<int:opp_id>/workers/deliver/", WorkerDeliverView.as_view(), name="worker_deliver"),
    path("<int:opp_id>/workers/payments/", WorkerPaymentsView.as_view(), name="worker_payments"),
    path(
