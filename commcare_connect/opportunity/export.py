...
def export_user_status_table(opportunity: Opportunity) -> Dataset:
    ...
    table = UserStatusTable(access_objects, exclude=("username_popup", "date_popup"))
...
def export_deliver_status_table(opportunity: Opportunity) -> Dataset:
    ...
    table = DeliverStatusTable(access_objects, exclude=("details", "username_popup", "date_popup"))
