...
from commcare_connect.opportunity.tables import PaymentAndVerificationTable, UserStatusTable, UserVisitTable
...
def export_payment_and_verification_table(opportunity: Opportunity) -> Dataset:
    ...
    table = PaymentAndVerificationTable(access_objects)
