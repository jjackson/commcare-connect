"""
Proxy models for Task ExperimentRecords.

These proxy models provide convenient access to ExperimentRecord data
for the tasks workflow, following the pattern established in audit and solicitations.
"""
...
class TaskRecord(ExperimentRecord):
    """Proxy model for Task-type ExperimentRecords."""
