...
from commcare_connect.labs.data_explorer.data_access import RecordExplorerDataAccess
from commcare_connect.labs.data_explorer.forms import RecordEditForm, RecordFilterForm, RecordUploadForm
from commcare_connect.labs.data_explorer.tables import LabsRecordTable
from commcare_connect.labs.data_explorer.utils import (
...
class RecordListView(LoginRequiredMixin, SingleTableView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Get distinct values for filter choices
        experiment_choices = []
        type_choices = []
        ...
        if form.is_valid():
            ...
            try:
                ...
                try:
                    ...
                    return redirect(reverse("data-explorer:list"))
                finally:
                    data_access.close()
            except Exception as e:
...
class RecordDownloadView(LoginRequiredMixin, View):
...
class RecordUploadView(LoginRequiredMixin, View):
