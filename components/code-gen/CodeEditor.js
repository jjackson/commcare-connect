...
// Library code - helper functions available to user code but hidden from editor
// This could be extracted to a separate file if needed, but kept inline for webpack compatibility
const LIBRARY_CODE = `
